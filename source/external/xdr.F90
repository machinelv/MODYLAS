...
! Modified by Ryo Urano (2018)
! Based on Kai-Min Tu (2014) from Barnett's work, the interface for TRR file is incorporated
...
contains
    ...
    subroutine write_xtcfile(xtc, natoms, step, time, box, pos, prec)
        ...
        ! write(*,*) "check natoms,step,time, box(3, 3), pos(:, :), prec"
        ! write(*,*) natoms, step, time, box(3, 3), pos(1:3,1:5), prec
