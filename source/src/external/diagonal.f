!>
!! \file
!! \brief Subroutines for diagonalization of the matrix and finding eigenvalues and eigenvectors of it
!! \author EISPACK.
!! \details This code bases on rg.f in the EISPACK.
!!          [Comput.Phys.Commun.,7,179-184,1974)]
!<
      subroutine diagonal (a,wr,z)
c   
      integer n,nm,is1,is2,ierr,matz
      parameter(n=3,nm=3,matz=1)
