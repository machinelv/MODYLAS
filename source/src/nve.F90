...
contains
  ...
  !>
  !! \brief  Subroutine to integrate the equation of motion 
  !!         (NVE ensemble)
  !! \author Noriyuki Yoshii, Kensuke Iwahashi
  !<
...
!$omp end parallel
  ...
  !----------------------------------------------------------------------
  !>
  !! \brief  Subroutine to calculate outputs (NVE ensemble)
  ...
  end subroutine calc_hamiltonian_nve
